...
export const blogData: Record<string, BlogPost> = {
  "future-of-enterprise-architecture": {
    ...
    description:
      "The transition to cloud-native deployments is a fundamental shift in how businesses operate, scale, and deliver value.",
    date: "March 15, 2026",
    readTime: "6 min read",
    ...
    coverImage: "/home/Next-Gen.png", // Using existing image assets for demo
    content: `
  ...
  "building-scalable-nextjs-applications": {
    ...
    description:
      "Next.js has revolutionized React, but scaling a Next.js architecture requires careful consideration of data fetching and caching.",
  ...
  "leading-high-performance-engineering-teams": {
    ...
    description:
      "Building a high-performance engineering team requires creating an environment built on psychological safety and aligned goals.",
  ...
  "mastering-framer-motion": {
    ...
    description:
      "Animation guides the user's attention. Framer Motion is the definitive tool for orchestrating these seamless experiences.",
    date: "April 12, 2026",
    readTime: "7 min read",
  ...
  "nextjs-app-router-architecture": {
    ...
    description:
      "The App Router represents a paradigm shift in React architecture, moving to a server-first mental model to reduce JavaScript.",
  ...
  "component-driven-design": {
    ...
    description:
      "Component-Driven Design flips UI development, building applications from the bottom up to ensure perfect consistency.",
