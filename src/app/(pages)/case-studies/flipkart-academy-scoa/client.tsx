...
export default function FlipkartCaseStudyClient() {
  const study = caseStudies.find((c) => c.slug === "flipkart-academy-scoa");
        ...
        {study.frontendChallenges && (
          <section className="mb-24 md:mb-32">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16">
              {/* @ts-ignore */}
              {study.frontendChallenges.map((chal, idx) => (
                <div
                  key={idx}
                  className="border border-black p-10 bg-white hover:bg-gray-50 transition-colors"
                >
        ...
        {study.methodology && (
          <section className="mb-24 md:mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* @ts-ignore */}
              {study.methodology.map((phase, idx) => (
                <div
                  key={idx}
                  className="border border-black/10 p-8 bg-gray-50 hover:border-black transition-colors flex flex-col h-full"
                >
                  <h3 className="text-sm font-semibold uppercase tracking-widest text-black mb-4">
                    {phase.month}
                  </h3>
                  <p className="text-gray-600 text-sm font-light leading-relaxed mt-auto">
                    {phase.description}
                  </p>
                </div>
              ))}
