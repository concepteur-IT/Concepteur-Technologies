...
export default function SocialMediaInfrastructureCaseStudyClient() {
  return (
          ...
          <div className="md:col-span-8 lg:col-span-9">
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-8 border border-gray-100 bg-[#FAFAF9] group hover:bg-[#0b2f33] hover:text-white hover:border-[#0b2f33] transition-colors custom-notch-tl-br flex flex-col justify-between"
                >
                  <h5 className="text-xs font-bold uppercase tracking-widest text-black group-hover:text-white mb-8 flex items-center justify-between border-b border-gray-200 group-hover:border-white/20 pb-4">
                    <span>{cs.title}</span>
                    <span className="text-[#f5ad76] font-mono">0{i + 1}</span>
                  </h5>
                  <div className="space-y-8">
                    <div>
                      <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-gray-500 group-hover:text-[#f5ad76] mb-3">
                        Challenge
                      </span>
                      <p className="text-black group-hover:text-white font-light leading-relaxed text-base">
                        {cs.challenge}
                      </p>
                    </div>
                    <div>
                      <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-[#0b2f33] group-hover:text-[#f5ad76] mb-3">
                        Solution
                      </span>
                      <p className="text-gray-600 group-hover:text-gray-300 font-light leading-relaxed text-base">
                        {cs.solution}
                      </p>
                    </div>
                  </div>
