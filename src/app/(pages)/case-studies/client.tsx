          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
                Every engagement starts with operational systems and ends with
                measurable business impact. We connect technology, automation,
                data, and execution into outcomes that scale.
              </p>
            </motion.div>
            ...
            <div className="relative h-[680px] flex items-center justify-center">
              ...
              >
                ...
                <h3 className="text-xl font-medium">Measurable Outcomes</h3>
              </motion.div>
                  ...
                  >
                    <div className="flex flex-col h-full cursor-pointer">
                      ...
                      <Link
                        ...
                        className={`relative w-full overflow-hidden ${style.imageOrder} block`}
                        aria-label={`Open ${item.title} case study`}
                      >
                        <img
                          src={item.heroImage || imgPlaceholder}
                          alt={item.title}
