                  ...
                  {!isAlternateLayout ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                      ...
                      >
                        <Link
                          href={`/capabilities/${service.slug}`}
                          className="block w-full lg:max-w-md aspect-[4/3] bg-gray-100 relative custom-notch-tl-br overflow-hidden mb-8"
                        >
                          <Image
                            src={img}
                            alt={service.title}
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-6">
                            {service.stats.slice(0, 2).map((stat, i) => (
                              <div
                                key={i}
                                className="flex justify-between items-center px-4 py-3 bg-gray-100/50"
                              >
      ...
      <section className="w-full py-24 md:py-32 border-t border-gray-200">
        <div className="w-full px-5 md:px-[15%]">
          <div className="max-w-4xl">
            ...
            >
              Let&apos;s discuss how our capabilities can dramatically
              accelerate your core business objectives.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
