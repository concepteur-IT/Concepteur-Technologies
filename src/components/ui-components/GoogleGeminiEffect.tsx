...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div
      className={`sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden ${className || ""}`}
    >
      <div className="relative z-10 flex flex-col items-center -mt-32">
        <p className="text-4xl md:text-6xl font-normal pb-4 text-center text-black max-w-4xl mx-auto tracking-tight">
          {title || `Build with Aceternity UI`}
        </p>
        <p className="text-sm md:text-lg font-normal text-center text-gray-500 mt-4 max-w-lg mx-auto">
          {description ||
            `Scroll this component and see the bottom SVG come to life`}
        </p>
      </div>

      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1440px] pointer-events-none mt-16 md:mt-24">
        <svg
          width="100%"
          height="100%"
