...
const LearnMoreBtn = () => {
  return (
    ...
    >
      Learn More
      <svg className="w-[14px] h-[14px] shrink-0 transition-transform duration-300 group-hover:rotate-45" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
